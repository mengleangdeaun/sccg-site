...
// Export the metadata for the Careers page
export const metadata: Metadata = {
  title: "Careers & Opportunities",
  description: "Join our team at SCC Group. We build human capital through structured hiring, intensive onboarding, and performance-based promotion.",
  openGraph: {
    title: "Join Our Team | SCC Group",
    ...
    url: "https://www.scc-group.asia/careers",
  }
};
        ...
        <div className="mb-24">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {mandates.map((item) => (
              <div
                key={item.id}
                className={`group p-8 bg-white dark:bg-zinc-950 backdrop-blur-sm border transition-all duration-300 relative flex flex-col justify-between rounded-none ${
                  item.highlight
