  ...
  return (
    <div className="relative min-h-screen bg-white dark:bg-zinc-950 text-zinc-900 dark:text-zinc-50 font-sans antialiased transition-colors duration-300 overflow-x-hidden">
      ...
      <main className="relative z-10 max-w-7xl mx-auto px-6 pt-24 pb-24">
        ...
        {/* Divider */}
        <div className="border-t border-zinc-200 dark:border-white/10 mb-16" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 border border-zinc-200 dark:border-white/10 mb-20">
          {/* Mission */}
          <div className="p-7 border-b md:border-b-0 md:border-r border-zinc-200 dark:border-white/10 bg-white dark:bg-zinc-900">
          ...
          {/* Dream */}
          <div className="p-7 bg-white dark:bg-zinc-900">
            <div className="w-8 h-8 bg-red-50 dark:bg-red-950/40 flex items-center justify-center mb-5">
              <svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" strokeLinecap="square" strokeLinejoin="miter" className="text-red-600 dark:text-red-500">
            ...
            <p className="text-sm leading-relaxed text-zinc-600 dark:text-zinc-400">
              A vibrant international enterprise combining exceptional talent across cultures — creating infrastructure that permanently elevates human quality of life.
            </p>
          </div>
        </div>
